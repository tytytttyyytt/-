<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="returnHouse.aspx.cs" Inherits="HouseRetetalSystemV2.Page.returnHouse" %>
    ...
    <el-menu unique-opened>
      ...
      <el-submenu index="3">
        ...
        <el-menu-item-group>
          ...
          <el-menu-item index="3-1">退房</el-menu-item>
        </el-menu-item-group>
...
<script type="text/javascript">
    window.onload = function () {
        ...
        var returnJson = localStorage.getItem("returnForUser");
        var returnInfo = JSON.parse(returnJson);
        ...
        new Vue({
            ...
            data() {
                ...
                for (let i = 0; i < returnInfo.length; i++) {
                    var tempObject = {
                        orderNo: returnInfo[i]["订单号"],
                        accout: returnInfo[i]["账号"],
                        cost: returnInfo[i]["租价"],
                        stime: returnInfo[i]["租出时间"],
                    };
            ...
            methods: {
                deleteRow(index, rows) {
                    this.$confirm('是否归还该房?', '提示', {
                        ...
                        var url = '/API/Info/RetentHouse?account=' + Haccount + "&uaccount=" + Uaccount;
                        var self = this;
                        this.$http.get(url).then(function (res) {
                            ...
                            // 刷新租房列表数据
                            var urlReturn = "/API/Info/GetRetentingRecord?account=" + user.account;
                            var self = this;
                            this.$http.get(urlReturn).then(function (res) {
                                var result = res.body;
                                console.log(result);
