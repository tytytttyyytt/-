    ...
    <v-container fluid>
      <v-row dense>
        ...
        <v-col :cols="cards[1].flex">
          <v-card class="mx-auto" color="#FBC02D" dark max-width="800">
            <v-card-title>
              <v-icon large left>
                mdi-account
              </v-icon>
            ...
            <v-card-text v-html="teacherInfo" class="headline font-weight-bold"></v-card-text>
            ...
            <v-card-actions>
              <v-list-item class="grow">
                ...
                <v-row align="center" justify="end">
                  <router-link tag="div" v-bind:to="toTeacherInfo">
...
export default {
  ...
  data: () => ({
    ...
    sex: 1,
    teacherInfo: "默认",
    toTeacherInfo: "/teacherInfo",
    publicInfo: "/opencourseteacher"
  }),
  methods: {},
  ...
  created: function() {
    ...
    if (this.userInfo.zz_Level15 == 0) {
      this.teacherInfo =
        "职称：助教&nbsp;&nbsp;&nbsp;&nbsp;教师编号：" + this.userInfo.zz_Tno15;
    } else if (this.userInfo.zz_Level15 == 1) {
      this.teacherInfo =
        "职称：讲师&nbsp;&nbsp;&nbsp;&nbsp;教师编号：" + this.userInfo.zz_Tno15;
    } else if (this.userInfo.zz_Level15 == 2) {
      this.teacherInfo =
        "职称：副教授&nbsp;&nbsp;&nbsp;&nbsp;教师编号：" + this.userInfo.zz_Tno15;
    } else if (this.userInfo.zz_Level15 == 3) {
      this.teacherInfo =
        "职称：教授&nbsp;&nbsp;&nbsp;&nbsp;教师编号：" + this.userInfo.zz_Tno15;
    }
  }
};
</script>
